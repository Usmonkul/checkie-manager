...
const Intro = () => {
  return (
    <div className="relative left-5 top-10 flex flex-col space-y-24 text-black pt-10">
      {/* Hero */}
      ...
      {/* CTO */}
      <div className="flex flex-col items-center space-y-10 bg-green-200/40 py-12 relative -left-10">
      ...
      {/* Card */}
      <div className="p-6 w-full dark:bg-gray-800 dark:text-gray-100 relative -left-10">
      ...
      {/* Footer */}
      <div className="bg-black w-full h-auto text-white flex flex-col items-center py-7 space-y-4 relative -left-10 ">
